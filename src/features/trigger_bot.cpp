...
TriggerBot g_trigger_bot;

namespace {
    constexpr float kCrosshairTolerance = 4.f; // pixels
    constexpr float kHeadOffset = 64.f;        // approx head height above origin
...
void TriggerBot::update(bool enabled, float delay_seconds) {
    if (!enabled) {
